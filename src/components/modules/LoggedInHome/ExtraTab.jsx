    ...
    <div className="extra ng-star-inserted">
      <div className="row mx-0 mb-1 d-none d-md-flex">
        <div className="col-md-4 px-0">
          <a href="javascript:void(0);" className="button_dakred">
            Our casino
          </a>
        </div>
        <div className="col-md-4 px-1">
          <a href="javascript:void(0);" className="button_darkyellow">
            Int casino
          </a>
        </div>
        <div className="col-md-4 px-0">
          <a href="javascript:void(0);" className="button_orange">
            Sports Book
          </a>
        </div>
      </div>
      <div className="row mx-0 d-flex d-md-none ng-star-inserted">
        ...
        <div className="col-3 px-1 mb-1 d-block ng-star-inserted">
          <a>
            <img className="img-fluid" src="/src/assets/images/lucky_5.png" />
          </a>
        </div>
        <div className="col-3 px-1 mb-1 d-block ng-star-inserted">
          <a>
            <img className="img-fluid" src="/src/assets/images/lucky_15.png" />
          </a>
        </div>
        <div className="col-3 px-1 mb-1 d-block ng-star-inserted">
          <a>
        ...
        <div className="col-3 px-1 mb-1 d-block ng-star-inserted">
          <a>
            <img className="img-fluid" src="/src/assets/images/baccarat.png" />
          </a>
        </div>
        <div className="col-3 px-1 mb-1 d-block ng-star-inserted">
          <a>
        ...
        <div className="col-3 px-1 mb-1 d-block ng-star-inserted">
          <a>
            <img className="img-fluid" src="/src/assets/images/roulette.png" />
          </a>
        </div>
        ...
        <div className="col-3 px-1 mb-1 d-none ng-star-inserted">
          <a>
            <img className="img-fluid" src="/src/assets/images/lucky7.png" />
          </a>
        </div>
        <div className="col-3 px-1 mb-1 d-none ng-star-inserted">
          <a>
        ...
        <div className="col-3 px-1 mb-1 d-none ng-star-inserted">
          <a>
            <img className="img-fluid" src="/src/assets/images/32cards.png" />
          </a>
        </div>
        <div className="col-3 px-1 mb-1 d-none ng-star-inserted">
          <a>
        ...
        <div className="col-3 px-1 mb-1 d-none ng-star-inserted">
          <a>
            <img className="img-fluid" src="/src/assets/images/queenrace.png" />
          </a>
        </div>
        <div className="col-3 px-1 mb-1 d-none ng-star-inserted">
          <a>
            <img className="img-fluid" src="/src/assets/images/race2020.png" />
          </a>
        </div>
        <div className="col-3 px-1 mb-1 d-none ng-star-inserted">
          <a>
        ...
        <div className="col-3 px-1 mb-1 d-none ng-star-inserted">
          <a>
            <img className="img-fluid" src="/src/assets/images/duskadum.png" />
          </a>
        </div>
        <div className="col-3 px-1 mb-1 d-none ng-star-inserted">
          <a>
        ...
        <div className="col-3 px-1 mb-1 d-none ng-star-inserted">
          <a>
            <img className="img-fluid" src="/src/assets/images/raceto2nd.png" />
          </a>
        </div>
        <div className="col-3 px-1 mb-1 d-none ng-star-inserted">
          <a>
            <img className="img-fluid" src="/src/assets/images/lottery.png" />
          </a>
        </div>
        <div className="col-3 px-1 mb-1 d-none ng-star-inserted">
          <a>
            <img className="img-fluid" src="/src/assets/images/superover.png" />
          </a>
        </div>
        <div className="col-3 px-1 mb-1 d-none ng-star-inserted">
          <a>
        ...
        <div className="col-3 px-1 mb-1 d-none ng-star-inserted">
          <a>
            <img className="img-fluid" src="/src/assets/images/casinowar.png" />
          </a>
        </div>
        <div className="col-3 px-1 mb-1 d-none ng-star-inserted">
          <a>
        ...
        <div className="col-3 px-1 mb-1 d-none ng-star-inserted">
          <a>
            <img className="img-fluid" src="/src/assets/images/raceto17.png" />
          </a>
        </div>
        <div className="col-3 px-1 mb-1 d-none ng-star-inserted">
          <a>
        ...
        <div className="col-3 px-1 mb-1 d-none ng-star-inserted">
          <a>
            <img className="img-fluid" src="/src/assets/images/highlow.png" />
          </a>
        </div>
        <div className="col-3 px-1 mb-1 d-none ng-star-inserted">
          <a>
        ...
        <div className="col-lg-12">
          <div className="card">
            <div className="card-body card-content p-0">
              ...
              <div id="HorseRacing" className="bet-table-body collapse show">
                <div className="race-section ng-star-inserted">
                  ...
                  >
                    ...
                    <div className="race_detail">
                      <span className="race_time" style={{ fontWeight: 700 }}>
                        10:52 AM{" "}
                      </span>
