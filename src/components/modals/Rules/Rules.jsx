    ...
    <>
      ...
      >
        ...
        <div role="document" className="modal-dialog modal-lg">
          <div className="modal-content" ref={rulesRef}>
            <div>
                                    ...
                                    <table className="table table-bordered">
                                      <tbody>
                                        <tr>
                                          <td>
                                            <span>
                                              Total match 1st over run:- Average
                                              6 runs will be given if total 20
                                              overs is not played, only 1st
                                              innings will be considered as
                                              valid
                                            </span>
                                          </td>
                                        </tr>
                                        ...
                                        <tr>
                                          <td>
                                            <span>
                                              Total 1st 6 over run:- Average 46
                                              runs will be given if total 20
                                              overs is not played, This event is
                                              valid only for the 1st innings
                                            </span>
                                          </td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                          <td>
                                            <span>
                                              Total Extras - Average 14 extras
                                              will be given in case match
                                              abandoned or over reduced
                                            </span>
                                          </td>
                                        ...
                                        <tr>
                                          <td>
                                            <span>
                                              Total Caught out - Average 8 catch
                                        ...
                                        <tr>
                                          <td>
                                            <span>
                                              Highest 6 over run: Both innings
                                              are valid
                                            </span>
                                          </td>
                                        </tr>
                                        <tr>
                                          <td>
                                            <span>
                                              Highest run in individual match:
                                        ...
                                        <tr>
                                          <td>
                                            <span>
                                              Highest match 1st over run in
                                              individual match: Only 1st inning
                                              will be considered as valid valid
                                            </span>
                                          </td>
                                        </tr>
                                        <tr>
                                          <td>
                                            <span className="text-danger">
                                              All events related to bowler are
                                              valid only for the league stages,
                                              both the innings will be
                                              considered as valid. A minimum of
                                              32 overs has to be bowled else the
                                              same will be voided. If the
                                              mentioned bowler has bowled one
                                              legal delivery then it will be
                                              considered as 1 over even if the
                                              over is not completed
                                            </span>
                                          </td>
                                        </tr>
                                        <tr>
                                          <td>
                                            <span className="text-danger">
                                              All events based on ground are
                                              decided based on the initial
                                              fixture, in case of any changes in
                                              the venue between the series. Then
                                              average will be given based on the
                                              initial fixture for the number of
                                              games reduced, Similarly if any
                                              match is added newly to the venue
                                        ...
                                        <tr>
                                          <td>
                                            <span className="text-danger">
                                              Average for wickets taken will be
                                              given in case match abandoned or
                                              over reduced or the player has not
                                              bowled single legal delivery
                                              before the over got reduced
                                            </span>
                                          </td>
                                        </tr>
                                        <tr>
                                          <td>
                                            <span className="text-danger">
                                              ...
                                              teams/players/ground are valid
                                        ...
                                        <tr>
                                          <td>
                                            <span>
                                              Total 6 over run:- Average 46 runs
                                              will be given if total 20 overs is
                                              not played, only 1st innings will
                                        ...
                                        <tr>
                                          <td>
                                            <span>
                                              Total Wide – Average 8 Wide will
                                              be given in case match abandoned
                                              or over reduced
                                            </span>
                                          </td>
                                        ...
                                        <tr>
                                          <td>
                                            <span>
                                              Total Run- Average 330 runs will
                                              be given in case match abandoned
                                              or over reduced
                                            </span>
                                          </td>
                                        ...
                                        <tr>
                                          <td>
                                            <span>
                                              Total 6 over run:- Average 44 runs
                                              will be given if total 20 overs is
                                              not played, only 1st innings will
                                              be considered as valid
                                            </span>
                                        ...
                                        <tr>
                                          <td>
                                            <span>
                                              Total Extras - Average 13 Extras
                                              will be given in case match
                                              abandoned or over reduced
                                            </span>
                                          </td>
                                        ...
                                        <tr>
                                          <td>
                                            <span>
                                              Total Run- Average 318 runs will
                                              be given in case match abandoned
                                              or over reduced
                                            </span>
                                          </td>
                                        ...
                                        <tr>
                                          <td>
                                            <span>
                                              Total 6 over run:- Average 45 runs
                                              will be given if total 20 overs is
                                              not played, only 1st innings will
                                              be considered as valid
                                            </span>
                                        ...
                                        <tr>
                                          <td>
                                            <span>
                                              Total Run- Average 320 runs will
                                              be given in case match abandoned
                                              or over reduced
                                            </span>
                                          </td>
                                        ...
                                        <tr>
                                          <td>
                                            <span>
                                              Total Run- Average 310 runs will
                                              be given in case match abandoned
                                              or over reduced
                                            </span>
                                          </td>
                                        ...
                                        <tr>
                                          <td>
                                            <span>
                                              Total Run- Average 315 runs will
                                              be given in case match abandoned
                                              or over reduced
                                            </span>
                                          </td>
                                        ...
                                        <tr>
                                          <td>
                                            <span>
                                              Total Wide – Average 9 Wide will
                                              be given in case match abandoned
                                              or over reduced
                                            </span>
                                          </td>
                                        ...
                                        <tr>
                                          <td>
                                            <span>
                                              Total Extras - Average 16 Extras
                                              will be given in case match
                                              abandoned or over reducedTotal
                                              Extras - Average 16 Extras will be
                                              given in case match abandoned or
                                              over reduced
                                            </span>
                                          </td>
                                        ...
                                        <tr>
                                          <td>
                                            <span>
                                              Total Run- Average 340 runs will
                                              be given in case match abandoned
                                              or over reduced
                                            </span>
                                          </td>
                                        ...
                                        <tr>
                                          <td>
                                            <span>
                                              Total Run- Average 335 runs will
                                              be given in case match abandoned
                                              or over reduced
                                            </span>
                                          </td>
                                        ...
                                        <tr>
                                          <td>
                                            <span className="text-danger">
                                              Average will be given for player
                                              if the mentioned player is not
                                              included in the playing 11
                                            </span>
                                          </td>
                                        </tr>
                                        <tr>
                                          <td>
                                            <span className="text-danger">
                                              If the mentioned player is not
                                              included in playing 11 for 3
                                              consecutive matches and the
                                    ...
                                    <table className="table table-bordered">
                                      <tbody>
                                        ...
                                        <tr>
                                          <td>
                                            <span>
                                              1.1 Completed game is valid , in
                                        ...
                                        <tr>
                                          <td>
                                            <span>
                                              1.3 All bets regarding Odd/Even
                                              sessions will be deleted if the
                                              particular session is incomplete,
                                              for example match got abandoned or
                                        ...
                                        <tr>
                                          <td>
                                            <span className="text-danger">
                                              2.1 If any player does not come as
                                        ...
                                        <tr>
                                          <td>
                                            <span>
                                              2.2 two players done the same run
                                        ...
                                        <tr>
                                          <td>
                                            <span>
                                              Suppose we have opened value of M
                                              Agarwal 3.75 back and customer
                                        ...
                                        <tr>
                                          <td>
                                            <span>
                                              Whole inning result announces 30
                                    ...
                                    <table className="table table-bordered">
                                      <tbody>
                                        ...
                                        <tr>
                                          <td>
                                            <span className="text-danger">
                                              15.Traders will be block the user
                                        ...
                                        <tr>
                                          <td>
                                            <span>
                                              ...
                                              other teams 1st day score will be
                                        ...
                                        <tr>
                                          <td>
                                            <span>
                                              How many balls for 50 runs fancy
                                              any team only first inning valid.
                                            </span>
                                          </td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                          <td>
                                            <span>
                                              ...
                                              he havent completed the over. For
                                        ...
                                        <tr>
                                          <td>
                                            <span className="text-danger">
                                              ...
                                              total 4s is 24 and third match
                                              total 4s is 26, So Result of Total
                                              4s is 70
                                            </span>
                                          </td>
                                        </tr>
                                    ...
                                    <table className="table table-bordered">
                                      <tbody>
                                        <tr>
                                          <td>
                                            <span className="text-danger">
                                              IPL Special 2024 Valid Only For
                                              First 21 Matches. If IPL fixture
                                              of 21 matches gets reduced due to
                                              any reason, then all the special
                                              fancies will be voided (Match
                                              abandoned due to rain/bad light
                                        ...
                                        <tr>
                                          <td>
                                            <span>
                                              Total 1st over runs: Average 6
                                              runs will be given in case match
                                              abandoned or over reduced (only
                                              1st innings valid)
                                            </span>
                                          </td>
                                        </tr>
                                        <tr>
                                          <td>
                                            <span>
                                              Total 1st 6 over run:- Average 48
                                              runs will be given in case match
                                              abandoned or over reduced (Only
                                              1st Innings valid)
                                            </span>
                                        ...
                                        <tr>
                                          <td>
                                            <span>
                                              Total fours: Average 28 fours will
                                              be given in case match abandoned
                                              or over reduced
                                            </span>
                                          </td>
                                        ...
                                        <tr>
                                          <td>
                                            <span>
                                              Total sixes: Average 14 sixes will
                                              be given in case match abandoned
                                              or over reduced
                                            </span>
                                          </td>
                                        ...
                                        <tr>
                                          <td>
                                            <span>
                                              How many matches win by a team :
                                              Only valid for league stage
                                              matches. Ex. For CSK, How many
                                              matches CSK win during league
                                              stages only considered. Playoffs
                                        ...
                                        <tr>
                                          <td>
                                            <span>
                                              Most 4s by individual batsman of
                                              IPL : Maximum Number of Fours Hit
                                              By A Batsman in full Tournament.
                                              Ex. Last Season (2021) R Gaikwad
                                              Hit 64 Fours in 16 Matches. So, 64
                                              was the Result for last season.
                                            </span>
                                          </td>
                                        </tr>
                                        <tr>
                                          <td>
                                            <span>
                                              Most 4s by an individual batsman
                                              in an Inning of IPL : Maximum
                                              Number of Fours Hit By A Batsman
                                              in one Innings. Ex. Last Season
                                              (2021) S Yadav Hit 13 Fours in
                                              55th league Match. So, 13 was the
                                        ...
                                        <tr>
                                          <td>
                                            <span>
                                              Most 6s by individual batsman of
                                              IPL : Maximum Number of Sixes Hit
                                              By A Batsman in full Tournament.
                                              Ex. Last Season (2021) KL Rahul
                                              Hit 30 Sixes in 13 Matches. So, 30
                                              was the Result for last season.
                                            </span>
                                          </td>
                                        </tr>
                                        <tr>
                                          <td>
                                            <span>
                                              Most 6s by individual batsman in
                                              an Inning of IPL : Maximum Number
                                              of Sixes Hit By A Batsman in one
                                              Innings. Ex. Last Season (2021) K
                                              Pollard Hit 8 Sixes in 27th league
                                              Match. So, 8 was the Result for
                                              last season.
                                            </span>
                                          </td>
                                        </tr>
                                        <tr>
                                          <td>
                                            <span>
                                              Most runs given by Bowler in an
                                              Inning of IPL : Maximum How much
                                              Runs conceded by a individual
                                              Bowler in an Innings. Ex : Last
                                              Season (2021) L Ngidi concede 62
                                              runs in 4 overs of 27th Match. So,
                                              62 was the Result for last season.
                                            </span>
                                          </td>
                                        </tr>
                                        <tr>
                                          <td>
                                            <span>
                                              Most wickets by Bowler in an
                                              inning of IPL : Maximum How much
                                              Wickets taken by a individual
                                              Bowler in an Innings. Ex : Last
                                              Season (2021) H Patel taken 5
                                              wickets in 1st Match. So, 5 was
                                        ...
                                        <tr>
                                          <td>
                                            <span>
                                              Most 50s by individual batsman of
                                              IPL : Maximum Number of Fifties
                                              Hit By A Batsman in full
                                              Tournament. Ex. Last Season (2021)
                                              Faf duPlessis Hit 6 fifties in 16
                                              Matches. So, 6 was the Result for
                                              last season.
                                            </span>
                                          </td>
                                        </tr>
                                        <tr>
                                          <td>
                                            <span>
                                              ...
                                              match of IPL : Maximum total runs
                                              of both Teams in individual match.
                                              Ex . Last Season (2021) RR vs PBKS
                                              match both teams Total runs 438
                                              (4th League Match) . So, 438 was
                                              the Result for Last Season.
                                            </span>
                                          </td>
                                        </tr>
                                        ...
                                        <tr>
                                          <td>
                                            <span>
                                              Highest Match 1st 6 over run: Only
                                        ...
                                        <tr>
                                          <td>
                                            <span>
                                              Most Balls Faced By a Batsman of
                                              IPL : Maximum balls Faced by an
                                              Individual Batsman in the Single M
                                            </span>
                                          </td>
                                        </tr>
                                        <tr>
                                          <td>
                                            <span>
                                              Most Dot balls By a Bowler in an
                                              Innings of IPL : Maximum Dot balls
                                              Bowled by a Bowler in his Quota.
                                              Wickets, Leg byes and Byes
                                              Considered as Dot ball
                                            </span>
                                          </td>
                                        </tr>
                                        <tr>
                                          <td>
                                            <span>
                                              Highest Match 1st over run: Only
                                              first Innings is valid
                                            </span>
                                          </td>
                                        </tr>
                                        ...
                                        <tr>
                                          <td>
                                            <span>
                                              ...
                                              over’s scored 10 runs or above.
                                              Team wise only 1st inning are
                                              valid and Match wise both innings
                                              are valid.
                                            </span>
                                          </td>
                                        </tr>
                                        <tr>
                                          <td>
                                            <span>
                                              Bowler Event :- 2 Over Wkts ,
                                              Dotballs , Boundaries , Runs bets
                                              vaild in 1st Two Overs (1st inning
                                              Vaild ) The mention Bowler has to
                                              Run(Start over) the defined number
                                              of Overs , else the bets related
                                              to that particular event will get
                                              void. For example if the mentioned
                                              bowler has bowled 3 Overs , then 2
                                              Over of that particular bowler
                                              will be considered as valid and
                                              the 4 Over will get void. If team
                                              get all out in the mentioned
                                              bowler Running Over then result
                                              considered as valid.. For example
                                              mentioned bowler 1.4 Over bowled
                                              &amp; team all out in 19.4 then
                                              bowler 2nd over result is valid
                                              and 4th over fancy is voided Or
                                              Bowler bowled 3.3 over &amp; team
                                              all out on 19.3 then Both 2 &amp;
                                              4 over is valid.
                                            </span>
                                          </td>
                                        </tr>
                                    ...
                                    <table className="table table-bordered">
                                      <tbody>
                                        ...
                                        <tr>
                                          <td>
                                            <span>
                                              ...
                                              Average 5 runs will be given in
                                              case match abandoned or over
                                              reduced (only 1st innings valid).
                                            </span>
                                          </td>
                                        ...
                                        <tr>
                                          <td>
                                            <span>
                                              ...
                                              Average 40 runs will be given in
                                              case match abandoned or over
                                              reduced (Only 1st Innings valid).
                                            </span>
                                          </td>
                                        ...
                                        <tr>
                                          <td>
                                            <span>
                                              5. Total 30s: Average 2 sixes will
                                              be given in case match abandoned
                                              or over reduced.
                                            </span>
                                          </td>
                                        ...
                                        <tr>
                                          <td>
                                            <span>
                                              7. Total Wickets - Average will 12
                                              Wickets be given in case match
                                              abandoned or over reduced.
                                            </span>
                                          </td>
                                        ...
                                        <tr>
                                          <td>
                                            <span>
                                              8. At any situation if result is
                                              given for any particular event
                                              based on the rates given for the
                                              same, then the particular result
                                              will be considered valid,
                                        ...
                                        <tr>
                                          <td>
                                            <span>
                                              11. Highest Match 1st over runs in
                                        ...
                                        <tr>
                                          <td>
                                            <span>
                                              14. Highest Wickets in individual
                                              match: Both innings are valid.
                                            </span>
                                          </td>
                                        </tr>
                                        ...
                                        <tr>
                                          <td>
                                            <span>
                                              17. Most 4s by individual batsman
                                        ...
                                        <tr>
                                          <td>
                                            <span>
                                              18. Most Dot balls By a Bowler in
                                        ...
                                        <tr>
                                          <td>
                                            <span>
                                              19. Most runs given by Bowler in
                                        ...
                                        <tr>
                                          <td>
                                            <span>
                                              20. Most wickets by Bowler in an
                                        ...
                                        <tr>
                                          <td>
                                            <span>
                                              21. In fastest fifty always the
                                              first 50 runs will be considered,
                                              for example of S Mandhana scores
                                              1st fifty in 17 balls and scores
                                              100 in next 14 balls, fastest 50
                                              will be given based on the balls
                                              for the 1st fifty runs Super over
                                    ...
                                    <table className="table table-bordered">
                                      <tbody>
                                        ...
                                        <tr>
                                          <td>
                                            <span>
                                              6. Total 30s: Average 2 Thirties
                                              will be given in case match
                                              abandoned or over reduced.
                                            </span>
                                          </td>
                                        ...
                                        <tr>
                                          <td>
                                            <span>
                                              25. Most 4s by individual batsman
                                              in an Inning : Maximum Number of
                                              Fours Hit By A Batsman in one
                                              Innings.
                                            </span>
                                        ...
                                        <tr>
                                          <td>
                                            <span>
                                              26. Most 6s by individual batsman
                                              in an Inning : Maximum Number of
                                    ...
                                    <table className="table table-bordered">
                                      <tbody>
                                        ...
                                        <tr>
                                          <td>
                                            <span>
                                              5. Ours non-runner rule relates to
                                              the adjustment of odds-on bets
                                              ...
                                              below) of that horses chances of
                                              ...
                                              the starters orders is deemed to
                                              be a non-runner.
                                            </span>
                                          </td>
                                        </tr>
                                        <tr>
                                          <td>
                                            <span>
                                              ...
                                              horse is given a reduction factor,
                                              based on a forecast price, which
                                              is expressed as a percentage.
                                              These reduction factors may be
                                              updated periodically at the
                                              discretion of the Us based on
                                              trading in the market, but after
                                              approximately 15 minutes
                                              (approximately 5 minutes for
                                              Australian and US markets) from
                                              the scheduled off time of a given
                                              race, they will be updated only in
                                    ...
                                    <table className="table table-bordered">
                                      <tbody>
                                        ...
                                        <tr>
                                          <td>
                                            <span className="text-danger">
                                              2. All sessions settlement price
                                              means result can be checked from
                                              exchanges official sites.
                                            </span>
                                          </td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                          <td>
                                            <span className="text-danger">
                                              ...
                                              only near months FUTURE price in
                                        ...
                                        <tr>
                                          <td>
                                            <span className="text-danger">
                                              5. Sessions timings : NFY, B-NFY,
                                              AXS, ICI, RIL, SBI, TT STL -
                                              Monday to Friday 10:00 a.m. to
                                              2:30 p.m. GOLD, SILVER, CRUDE -
                                              Monday to Friday 11:30 a.m. to
                                              10:30 p.m. CMX CRUDE, DOWJONES,
                                              NASDAQ, SNP - Monday to Friday
                                        ...
                                        <tr>
                                          <td>
                                            <span>
                                              ...
                                              apply to the relevant full regular
                                              time period including stoppage
                                              time. Any extra-time and/or
                                              penalty shoot-out is not included.
                                              For the cancellation of a goal,
                                              due to VAR, bets matched between
                                              the time of the goal being scored
                                              and the time at which the video
                                              assistant referee finishes the
                                    ...
                                    <table className="table table-bordered">
                                      <tbody>
                                        <tr>
                                          <td>
                                            <span className="text-danger">
                                              1. The final result declared by
                                              election commission of India for
                                              Loksabha election 2019 will be
                                              valid in our exchange.
                                            </span>
                                          </td>
                                        </tr>
                                        <tr>
                                          <td>
                                            <span className="text-danger">
                                              2. Accidental issues during
                                              Loksabha election 2019 will not be
                                              counted in our exchange.
                                            </span>
                                          </td>
                                        </tr>
                                      </tbody>
                                    ...
                                    <table className="table table-bordered">
                                      <tbody>
                                        <tr>
                                          <td>
                                            <span>
                                              To manage risk and ensure fair
                                              play, a maximum win cap applies to
                                              all casino games. The maximum
                                              payout per game round is capped at
                                              100× the original stake placed for
                                              that round. If a game round
                                              generates winnings exceeding 100×
                                              the stake, only 100× the stake
                                              amount will be credited to the
                                              user’s balance. <br />
                                              Any winnings above the 100× cap
                                        ...
                                        <tr>
                                          <td>
                                            <span>
                                              Example: Stake: ₹100 <br /> Game
                                              Result: 250× win (₹25,000) <br />{" "}
                                              Maximum allowed win: 100×
                                              (₹10,000) <br /> Amount credited:
                                              ₹10,000
                                            </span>
                                          </td>
                                        </tr>
                                        <tr>
                                          <td>
                                            <span>
                                              Remaining ₹15,000 will be voided.{" "}
                                              <br /> This rule applies to all
                                              casino games unless otherwise
                                              stated.
                                            </span>
                                          </td>
                                        </tr>
