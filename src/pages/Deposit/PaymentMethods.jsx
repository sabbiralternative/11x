            ...
            depositMethods?.map((method) => {
              return (
                <div
                  ...
                  _ngcontent-kdb-c159=""
                  className="accountdetailss  bg-secondary"
                >
                  <div
                    style={{
                      display: "flex",
          ...
          <div _ngcontent-kdb-c159="" className="accountdetail ng-tns-c159-13">
            ...
            >
              ...
              >
                ...
                >
                  <img style={{ height: "40px" }} src={img.phonpe} alt="" />
                  <img style={{ height: "40px" }} src={img.paytm} alt="" />
                  <img style={{ height: "40px" }} src={img.gpay} alt="" />
                  <img style={{ height: "40px" }} src={img.bhim} alt="" />
                </div>
              </div>
            </div>
          </div>
