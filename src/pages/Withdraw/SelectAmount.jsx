  ...
  return (
    ...
    >
      <div className="withdraw-section  ng-star-inserted">
        <div className="bonus-amount bg-secondary">
          <img loading="lazy" src={img.star} alt="" className="bonus-star1 " />
          <img loading="lazy" src={img.star} alt="" className="bonus-star2 " />
          <img loading="lazy" src={img.star} alt="" className="bonus-star3 " />
          <img loading="lazy" src={img.star} alt="" className="wallet-logo " />
          <div className="">
            <img
              loading="lazy"
              src={img.star}
            ...
            />
            <img loading="lazy" src={img.star} alt="" className="wallet-3d " />
          </div>
